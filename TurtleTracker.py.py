...
#
# Created by: Emily Mills(ecm42@duke.edu)
#
# Created on: Oct 2016
...
obsDate = obsDateTime.split()[0]    # Observation date - first item in obsDateTime list object; no parameters of.split default is space
